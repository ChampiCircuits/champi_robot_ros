...
def create_main_strategy(points_per_action: dict) -> StrategyBuilder:
    strategy = (StrategyBuilder(points_per_action)
        ...
        .set_init_pose(0.35, 1.8, -90.0) # nid jaune
        .set_home_pose(0.35, 1.8, -90.0) # nid jaune
        ...
        .move_to(Position(0.25, 1.4, -90.0), group="see_tag_before_thermo")
        .move_to(Position(0.25, 1.0, -90.0), group="see_tag_before_thermo")
