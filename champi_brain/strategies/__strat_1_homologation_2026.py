...
def create_main_strategy(points_per_action: dict) -> StrategyBuilder:
    strategy = (StrategyBuilder(points_per_action)
        ...
        .set_init_pose(1.0, 1.2, 150.0)
        .set_home_pose(1.0, 1.2, 150.0)

        # .take_elements_sequence(Position(0.175, 1.2, 180.0), which_actuator='RIGHT', group="caisses_1") # OK
        # .put_elements_sequence(Position(0.8, 0.8, -90.0), which_actuator='RIGHT', group="caisses_1", zone_id="garde_manger_3")
        ...
        .move_to(Position(1.0, 0.5, 160.0), group="see_tag_before_thermo")
