...
def create_main_strategy(points_per_action: dict) -> StrategyBuilder:   
    strategy = (StrategyBuilder(points_per_action)
        ...
        .create_group("sortie_grenier")
        .create_group("come_home")
        .create_group("on_the_side_for_pamis")
        ...
        .move_to(Position(0.4, 1.4, 0.0), group="sortie_grenier")
        .move_to(Position(0.5, 1.3, 0.0), group="sortie_grenier")
        ...
        # .move_to(Position(0.3, 1.1, 90.0), group="pousse_caisses_1")
        # .move_to(Position(0.6, 1.0, 90.0), group="pousse_caisses_1_") # on regarde le tag en haut à gauche
        # .move_to(Position(0.6, 1.3, 90.0), group="pousse_caisses_1_") # on recule un peu pour pas toucher caisses 3


        .take_elements_sequence(Position(1.15, 0.8, -90.0), which_actuator='RIGHT', group="caisses_3")
        .put_elements_sequence(Position(1.5, 0.8, 0.0), which_actuator='RIGHT', group="caisses_3", zone_id="garde_manger_6")
        ...
        .put_elements_sequence(Position(0.1, 0.8, 180.0), which_actuator='RIGHT', group="caisses_2", zone_id="garde_manger_1")
