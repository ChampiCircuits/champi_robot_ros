...
class TestProcessObservation(unittest.TestCase):
    ...
    def test_clustered_four_boxes(self):
        ...
        initial = [
            NutsBox('b1', 0.0, 0.0, 0.0, Color.NOT_INITIALIZED, ElementState.ON_TABLE),
            NutsBox('b2', 0.05, 0.0, 0.0, Color.NOT_INITIALIZED, ElementState.ON_TABLE),
        ...
        detections = [
            ...
            NutsBox('d3', -0.01, 0.06, 0.0, Color.NOT_INITIALIZED, ElementState.ON_TABLE),
            NutsBox('d4', 0.04, 0.04, 0.0, Color.NOT_INITIALIZED, ElementState.ON_TABLE),
        ]
        ws.process_observation(detections)
