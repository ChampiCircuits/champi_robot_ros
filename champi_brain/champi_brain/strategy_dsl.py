...
class StrategyBuilder:
    ...
    def move_thermometer(self, group: str) -> 'StrategyBuilder':
        ...
        self.move_relative_to(thermometer_initial_position, Offset(0.05, 0.19, 30.0, world_frame=True, theta_world_frame=True), use_collision_avoidance=True)
        self.custom_action(ActuatorCommand.THERMOMETER_LOWER_SERVO)
        self.move_relative_to(thermometer_target_position, Offset(0.05, 0.19, 30.0, world_frame=True, theta_world_frame=True), linear_tolerance=0.0025, speed=0.1)
