...
nodes=("base_controller_simu" "robot_state_publisher" "pub_goal_rviz" "twist_mux" "simu_lidar_node" "robot_stopped_detector" "ukf" "static_transform_publisher_map_odom" "base_controller" "imu_controller" "v4l2_camera_node")
